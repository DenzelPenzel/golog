...
func (s *segment) Read(off uint64) (*api.Record, error) {
	// convert the absolute index into a relative offset and get the associated index entry
...
// returns whether the segment has reached its max size, either by writing too much to the store or the index
